...
public class SpringbootJpaApplication implements CommandLineRunner {
	...
	public void whereIn() {
		...
		System.out.println("=============== consulta where in ==============");
		List<Person> persons2 = repository.getPersonsByIdsNot(Arrays.asList(1L, 2L, 5L, 7L));
	...
	public void personalizedQueriesConcatUpperAndLowerCase() {
		...
		regs.forEach(reg -> System.out
				.println("id=" + reg[0] + ", nombre=" + reg[1] + ", apellido=" + reg[2] + ", lenguage=" + reg[3]));
	...
	public void delete2() {
		...
		optinalPerson.ifPresentOrElse(person -> repository.delete(person),
