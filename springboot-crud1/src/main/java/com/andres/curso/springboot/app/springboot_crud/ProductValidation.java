...
public class ProductValidation implements Validator {
    ...
    public void validate(Object target,  Errors errors) {
        ...
        // ValidationUtils.rejectIfEmptyOrWhitespace(errors, "description", "NotEmpty.product.name");
        ...
        if (product.getPrice() == null) {
            ...
            errors.rejectValue("price", null, "deve ser un valor numerico mayor o igual que 500!");
        }
    }
